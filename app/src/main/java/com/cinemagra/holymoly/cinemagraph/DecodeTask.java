...
public class DecodeTask extends Thread {
    ...
    public DecodeTask(Context applicationContext, Surface surface, Uri fileUri) {
        super();
    ...
    private void init() {
        ...
        try {
            mExtractor.setDataSource(applicationContext, fileUri, null);
        ...
        while (!surfaceDestroyed) {
            ...
            switch (outIndex) {
                case MediaCodec.INFO_OUTPUT_BUFFERS_CHANGED:
                    ...
                    //mDecoder.getOutputBuffer(outIndex); - deprecated
                    break;
